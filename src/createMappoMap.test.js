...

{
  ...
  expect(mappoMap.tileLayers[0].tileIndexGrid).toEqual(List(filler(2 * 3, 77)))
  ...
  expect(mappoMap.tileLayers[1].tileIndexGrid).toEqual(List(filler(2 * 3, 88)))
...

{
  ...
  expect(mappoMap.tileLayers[0].tileIndexGrid).toEqual(List(filler(width * height, 77)))
  expect(mappoMap.tileLayers[0].parallax).toEqual({x: 1.0, y: 1.0})
  ...
  expect(mappoMap.tileLayers[1].tileIndexGrid).toEqual(List(filler(width * height, 88)))
  ...
  expect(mappoMap.tileLayers[2].tileIndexGrid).toEqual(List(filler(width * height, 99)))
